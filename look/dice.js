...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-e76a68d6');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-e76a68d6');}
...
var brandEl=document.querySelector('.rl-brand-e76a68d6');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
